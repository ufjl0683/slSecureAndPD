...
[NextStartTime] [datetime] NULL,
    ...
    [MetadataTypeAttribute(typeof(vwSingalIO.vwSingalIOMetadata))]
    public partial class vwSingalIO
    {

        // 這個類別可讓您將自訂屬性 (Attribute) 附加到 vwSingalIO 類別
        // 的 properties。
        //
        // 例如，下列程式碼將 Xyz 屬性標記為
        // 必要的屬性，並指定有效值的格式:
        ...
        //    [StringLength(32)]
        //    public string Xyz { get; set; }
        internal sealed class vwSingalIOMetadata
        {

            // 中繼資料類別本就不應該具現化。
            private vwSingalIOMetadata()
            {
            }
            ...
            public string ControllerConfig_ControlID { get; set; }
            ...
            public string SingalIO_Memo { get; set; }
