...
{
    public class R13NewSmrRTU : ModbusTCP.IRTU
    {
        ...
        public R13NewSmrRTU(string ControlID, int DevID, string IP, int Port, int StartAddress, int RegisterLength, int comm_state)
        {
